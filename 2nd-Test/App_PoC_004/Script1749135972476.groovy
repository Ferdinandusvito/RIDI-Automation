...
Mobile.waitForElementPresent(findTestObject('2nd-Test/App_PoC_004/FirstBigBanner-ThePowerISuddenlyGained'), 0)

Mobile.tap(findTestObject('2nd-Test/App_PoC_004/FirstBigBanner-ThePowerISuddenlyGained'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('2nd-Test/App_PoC_004/Header-FirstBigBanner'), 0)

Mobile.verifyElementVisible(findTestObject('2nd-Test/App_PoC_004/FirstBigBanner-Content'), 0)
